...
namespace CoffeeManager.Models
{
    public class RoutesConstants
    {
        ...
        public const string DiscardShift = Shift + "/DiscardShift";
        ...
        public const string ToggleCategoryEnabled = Products + "/ToggleCategoryEnabled";
        ...
        public const string GetUsersMotivation = Motivation + "/GetUsersMotivation";
